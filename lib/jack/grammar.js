(function () {
  ...
  bnf = {
    ...
    If: [
      ...
      ["if Ws Expression NEWLINE Block ELSE Block end", '$$ = {name: "If", condition: $3, yes: $5, no: $7}']
    ],
    Assign: [
    ...
    ListBlock: [
      ["ListItems", "$$ = $2"],
      ["ListBlock NEWLINE ListItems", "$$ = $1.concat($4)"]
    ],
    ListItems: [
      ["Expression", "$$ = [$1]"],
      ["ListItems Ws , Ws Expression", "$$ = $1.concat([$4])"]
    ],
    Object: [
