(function () {
  ...
  bnf = {
    ...
    Statement: [
      ...
      ["Expression WS if WS Expression NEWLINE", '$$ = {name: "If", condition: $5, yes: $1}'],
      ["Expression WS unless WS Expression NEWLINE", '$$ = {name: "If", condition: {name: "Not", value: $5}, yes: $1}']
    ],
    Comment: [
      ["COMMENT", "$$ = yytext"]
    ],
    ...
    If: [
      ...
      ["unless Ws Expression NEWLINE Block end", '$$ = {name: "If", condition: {name: "Not", value: $3}, yes: $5}'],
      ["unless Ws Expression NEWLINE Block else NEWLINE Block end", '$$ = {name: "If", condition: $3, yes: $8, no: $5}'],
    ],
    Assign: [
